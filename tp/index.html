...
// 单个文件限制
$max_file_size="51200";//大小指的KB，51200是50MB

// 所有文件限制
$max_combined_size="102400";//这个是8个文件一起上传的大小，102400KB是100MB
...
// 随机文件梦? true=使用 (推荐选择这个), false=使用原来文件名，false仅支持英文，不支持中文
// 随机文件名可以防止重复文件，如使用false有相同的文件无法上传.
$random_name=true;

// 系统允许上传文件的类型.
$allow_types=array("jpg","gif","png","zip","rar","txt","mp3","mp4","dex","lua","apk","js","json");
...
<header class="am-topbar am-topbar-fixed-top">
  <div class="am-container">
    <h1 class="am-topbar-brand">
      <i class="am-icon-file am-icon-spin"></i> 小k网络文件外链系统
    </h1>
...
<table align="center" class="table">
    <p class="am-text-xxl">小k网络文件外链系统</p>
    <p class="am-text-xl">严禁上传各类非法内容，请珍惜资源分享,以更新最高速度3MB左右高速直连上传地址http://wj.gylwj.club/wj本站网址采用24小时制24小时过后将清理所有文件若要长期保存的话，请进入高速链接进行上传高速链接一个月清理一次</p>
    <tr>
		<td class="table_header" colspan="2"><span class="am-btn am-btn-primary">单个文件限制50MB</span> <span class="am-btn am-btn-primary">8个文件上传限制100MB</span> </td>
	</tr>
    <tr>
...
<table class="table" style="border:0px;" align="center">
	<tr>
		<td><div class="copyright"></div></td>
          ...
          <footer class="footer">
  <p class="am-badge-primary">© 2020 小k网络文件外链系统  <a
</footer>
